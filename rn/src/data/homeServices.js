...
export const HOME_QUICK_SERVICES = [
  { id: 'airtime',    icon: 'smartphone',           label: 'Airtime',        color: '#031D5B', bg: '#E8ECF5', route: 'Airtime' },
...
export const ALL_SERVICES_SERVICES = [
  { id: 'savings', icon: 'account-balance', label: 'Savings', color: '#031D5B', bg: '#E8ECF5', route: 'SavingsHome' },
  ...HOME_QUICK_SERVICES,
];
